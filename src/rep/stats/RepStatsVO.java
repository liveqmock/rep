...
public class RepStatsVO implements Serializable {
	...
	public RepStatsVO( int sno , Date inputDate , double statis1 , double statis2 , double statis3 , double statis4 , double statis5 , double statis6 , int userId , double rpi , double rank , String problem , String param2 , String param1 ) {
		 this.sno = sno;
	...
	public RepStatsVO(Date inputDate ,double statis1 ,double statis2 ,double statis3 ,double statis4 ,double statis5 ,double statis6 ,int userId ,double rpi ,double rank ,String problem ,String param2 ,String param1 ) {
			 this.inputDate = inputDate;
			 this.statis1 = statis1;
			 this.statis2 = statis2;
			 this.statis3 = statis3;
